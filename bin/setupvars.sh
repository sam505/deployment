...
INSTALLDIR="${INTEL_OPENVINO_DIR:-/opt/intel/openvino_2020.1.023}"
...
# Not doing this command automatically as apparently openvino's python is too old for some classroom content
# so switching to the built-in environment automatically will confuse students. March 09, 2020
